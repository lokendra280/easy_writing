...
class SubscriptionPageAcademic extends StatefulWidget {
  const SubscriptionPageAcademic({super.key});

  @override
  _SubscriptionPageAcademicState createState() =>
      _SubscriptionPageAcademicState();
}

class _SubscriptionPageAcademicState extends State<SubscriptionPageAcademic> {
  int selectedCard = -1;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              const Text(
                'Benefits Included: Academic Writing',
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 17,
                  color: Color(
              ...
              const TextWithDividers(
                text:
                    "Study anytime, anywhere, offline, no distractions, and no ads",
                moreContext: true,
              ),
              const Divider(
                thickness: 1.5,
